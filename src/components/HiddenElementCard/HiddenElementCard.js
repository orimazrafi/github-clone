...
export const HiddenElementCard = props => <Card >
    <Grid container style={{ padding: "20px" }}>
        <Grid> <Avatar alt="@voronianski" style={{ height: "52px", width: "52px" }} height="52px" width="52px" src="https://avatars0.githubusercontent.com/u/974035?s=64&v=4" /></Grid>
        <Grid>
            <Container>
                <Grid container>
            ...
            <Container>*.js,*.lua,*.swift</Container>
            <Container>
                <SvgIcon
                    height="15px"
                    fill="gray"
    ...
    <Grid container>
        <Grid style={{ padding: "10px 20px" }}>
            ...
            <span> Member of <ClickedText inlineBlock="inline-block">SumUp</ClickedText>,<ClickedText inlineBlock="inline-block" margin="0 0 0 2px"> KOSMETISM</ClickedText>, and 7 more</span>
        </Grid>
    </Grid>
</Card>