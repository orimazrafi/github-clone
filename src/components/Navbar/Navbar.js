...
import { userName, navbarLinks, newLinks } from './../../helpers';
            ...
            >
                <AppBar position="static" style={{ background: colors.navbarColor }}>
                    <Toolbar >
                        ...
                        <div className={style.input_and_center_links}>
                        ...
                        <div className={style.right_links}>
                            ...
                            >
                                {newLinks.map(link => <BlueHoverBackground key={Math.random()}>
                ...
                <ModalPopup
                    ...
                    position="relative"
                >
                    <StatusModal busy={busy} handleChange={handleChange} status={status} handleStatus={handleStatus} onClose={handleCloseModal} />
                </ModalPopup>
            </div>
            <MobileLook mobile />
        </>
...
const MobileLook = (props) =>
    <div className={props.mobile ? style.bell_notification : ""}>
        <AppBar>
            <Toolbar position="static" style={{ background: colors.navbarColor }}>
                <IconButton edge="start"
                    className={style.stripe_icon}
                    color="inherit" aria-label="menu">
                    <MenuIcon />
...
const StatusModal = ({ busy, handleChange, status, handleStatus, onClose }) => <>
